...
| **Unordered SfM (EuRoC V2_03)** | 31 orderless monocular photos → VLAD view graph → incremental reconstruction: **30/31 registered**, **0.63 px** reproj, reproduces the ordered stereo model to **0.98 cm** (Sim(3)) |
