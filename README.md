...
Run a moving-camera GNSS-prior tracking example that narrows the visual map before localization and writes `tracking.csv`, `trajectory.csv`, JSON summaries, and browser-viewable reports:
