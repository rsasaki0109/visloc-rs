...
Run a moving-camera GNSS-prior tracking example that narrows the visual map before localization and writes an `index.html` dashboard, `tracking.csv`, `trajectory.csv`, JSON summaries, and browser-viewable reports:
