...
| **Unordered SfM (real photo collections)** | Orderless monocular photos → VLAD view graph → incremental reconstruction (P3P register, scale-gauge-fixed BA, iterative track filter), vs **COLMAP's own model** with an independent SuperPoint frontend: **COLMAP South Building** (128 photos) **128/128 reg, 0.59 cm**; **Gerrard Hall** (100 photos, 5616×3744 OPENCV) **95/100, 1.20 cm** — both **0.1 % of extent**. EuRoC V2_03 orbit **31/31, 1.08 cm** |
