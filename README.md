...
| **EuRoC loop closure (UAV)** | Same pipeline on a 6-DOF MAV flight, MH_03 (2700 frames, 307 loops, evo_ape vs Vicon/Leica GT). **SE(3) ATE rmse 2.46 m -> 0.46 m (5.3x)** | [`scripts/run_euroc_loop_closure_benchmark.sh`](scripts/run_euroc_loop_closure_benchmark.sh), [`docs/euroc_loop_closure_benchmark.md`](docs/euroc_loop_closure_benchmark.md) |
...
- [`docs/euroc_loop_closure_benchmark.md`](docs/euroc_loop_closure_benchmark.md) - the aerial counterpart: same pipeline on a EuRoC MH_03 6-DOF MAV flight (5.3x ATE vs Vicon/Leica GT), and why the frame-gap gate matters more at 20 Hz.
