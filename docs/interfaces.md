...
- `PoseTrajectory` and `TrajectorySample`: convert successful `TrackingResult` values into frame ids, poses, camera centers, path length, and reprojection-error summaries for sequence demos and evaluation export
