...
pub use visloc_slam::{
    ...
    IncrementalSfmError, IncrementalSfmResult, LandmarkInit, LinearSolver, LoopCandidatePair,
    LoopCandidateVerificationDiagnostic, LoopClosureCandidate, LoopClosureConfig,
