...
pub use visloc_slam::{
    ...
    MotionViInitializationStatus, MotionViRawResidualActivationConfig, OnlineBaImuStateRow,
    OnlineBaTriggerStats, OnlineSlamAdmittedLoopConstraint, OnlineSlamConfig,
